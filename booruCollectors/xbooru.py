...
def collector(downTag):
    print("Starting Xbooru Collector.")
    joined_tags = "+".join(downTag)
    baseURL = "https://xbooru.com/index.php?page=dapi&s=post&q=index"
    page = 0
    site = "xbooru"
    downloadList = []
    end = 0
    ...
    dir_tag = tag
    tag = tag + "/"
    tagPath = '/app/downloads/xbooru/' + tag
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                for post in data:
                    ...
                    dir_name = post['directory']
                    file_url = f'https://img.xbooru.com/images/{dir_name}/{file_name}'
                    postCount += 1
            ...
            if end != 1:
                print(f"Found {postCount} posts on page {page} of Xbooru.")
                page = page + 1
